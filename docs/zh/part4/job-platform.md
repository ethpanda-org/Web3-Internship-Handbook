...
1. [**Web3.career**](https://web3.career)
   - **简介：** Web3.career 是一个专注于 Web3 领域的全球性招聘平台，截至 2026 年 1 月，汇集了 70,281+ 个职位、7,085 个项目。其特点是职位更新及时，覆盖面广，且提供了详细的职位描述、公司信息和薪资数据。平台按地区、技能、职位类型等多个维度提供精准筛选，是 Web3 求职者的重要资源。
     <br>
2. [**DeJob(现已升级为 DeJob.ai)**](https://dejob.ai/)
   - **简介：** DeJob 是一个专注于 Web3 和远程招聘的平台,旨在帮助 Web3 项目方和求职者进行匹配。该平台支持免费发布职位，且职位更新较快，尤其适合国内 Web3 项目和求职者。注意：官方网站已从 dejob.top 升级为 dejob.ai，请使用最新地址。
     <br>
...
![项目可靠性评估表](../images/job-platform/project-reliability-assessment.png)
