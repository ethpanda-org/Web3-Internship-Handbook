...
去中心化的网络由无数节点提供服务来维持网络运行。以 PoW 链为例，这些操作常被称为“挖矿”，参与者一般被称为矿工。矿工（或 PoS 链中的验证者）维持网络运行需要奖励，就像你工作需要工资。更准确地说，节点收入通常由**协议奖励**与**交易手续费**两部分组成。你经常听说的燃料费（Gas Fee）属于交易手续费的一部分，并不等于全部节点奖励。
