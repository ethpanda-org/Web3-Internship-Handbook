...
export const zhTWNotes = defineNotesConfig({
  ...
  notes: [
    defineNoteConfig({
      ...
      sidebar: [
        { text: 'Web3 實習手冊', link: 'start/' },
        {
          text: '入門導讀',
          items: [
            { text: '區塊鏈基礎概念', link: 'blockchain-basic/' },
            { text: '以太坊概覽', link: 'overview-of-ethereum/' },
            { text: '行業賽道全覽', link: 'industry-knowledge/' },
            { text: 'Web3 工作方式', link: 'remote-work-guide/' },
          ],
          collapsed: false,
        },
        {
          text: 'Web3 行業知識',
          items: [
            { text: '區塊鏈崗位全景圖', link: 'position-introduction/' },
            { text: '智能合約開發', link: 'smart-contract-development/' },
            { text: '社群營運指南', link: 'community-intern/' },
            { text: '合規和網路安全', link: 'security/' },
          ],
          collapsed: false,
        },
        {
          text: '行業前輩訪談錄',
          items: [
            { text: '前端先鋒的鏈上闯關之路', link: 'logic-frontend-journey/' },
            { text: 'Web2 到 Web3 的轉型之路', link: 'jason-web2-to-web3-journey/' },
            { text: 'Web3 社群增長專家', link: 'julie-community-growth-expert/' },
            { text: '如何成為靠譜的 Web3 實習生', link: 'bruce-hiring-perspective/' },
          ],
          collapsed: false,
        },
        {
          ...
          collapsed: false,
          items: [
            { text: '招聘平台與職位推薦', link: 'job-platform/' },
            { text: 'Web3 行業履歷撰寫指導', link: 'write-resume/' },
            { text: '面試準備與典型面試題', link: 'interview-preparedness/' },
          ],
        },
        {
          text: '附錄',
          collapsed: false,
          items: [{ text: '附錄', link: 'appendix/' }],
        },
        { text: '致謝名單', link: 'acknowledgments/' },
      ],
    }),
  ],
});
