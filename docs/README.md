...
我们会在实习季开始前启动为期 ==1 个月==的实习生计划，围绕手册内容进行共学、答疑和模拟面试，并为你对接真实的实习机会。2025 冬季 Web3 实习计划已结束，官方平台为 <https://web3career.build>（用于报名学习和管理进度），历史项目页面仍保留，详情参见 <https://web3career.build/programs/web3-internship-bootcamp-2025-winter>。官方 X：<https://x.com/web3careerbuild>，官方 TG：<https://t.me/Web3CareerBuild>。
::: right
