...
- **以太坊詞彙表**：[Ethereum.org 官方詞彙表](https://ethereum.org/zh/glossary/)
- **行業黑話大全**：[WTF Academy - Web3 黑話大全](https://github.com/WTFAcademy/WTF-gm)
...
- **LearnWeb3**：[全棧 Web3 開發課程](https://learnweb3.io/)
- **Alchemy University**：[免費區塊鏈開發課程](https://university.alchemy.com/)
...
- **Patrick Collins**：[完整免費課程](https://www.youtube.com/watch?v=-1GB6m39-rM)
- **Dapp University**：[以太坊開發教程](https://www.youtube.com/c/DappUniversity)
- **Moralis Web3**：[全棧 DApp 開發](https://www.youtube.com/c/MoralisWeb3)
- **ETHGlobal**：[駭客松專案分享](https://www.youtube.com/c/ETHGlobal)
- **Ethereum Foundation**：[以太坊開發者大會](https://www.youtube.com/c/EthereumFoundation)
- **Bankless**：[行業最新動態](https://www.youtube.com/c/Bankless)
...
- **CoinDesk**：[全球加密貨幣新聞](https://www.coindesk.com/)
- **The Block**：[專業區塊鏈媒體](https://www.theblock.co/)

研究機構和論壇

- **以太坊研究院**：[ETH Research](https://ethresear.ch/)
- **Messari Research**：[加密市場研究](https://messari.io/research)
- **Delphi Digital**：[Web3 投研報告](https://www.delphidigital.io/)
...
- **ETHGlobal 駭客松**：[全球以太坊駭客馬拉松](https://ethglobal.com/)
...
- **Remix IDE**：[線上 Solidity IDE](https://remix.ethereum.org/) - 瀏覽器端開發除錯
- **VS Code + Solidity**：本地開發環境配置
- **Hardhat**：[現代化開發框架](https://hardhat.org/) - TypeScript 支援，豐富外掛
- **Foundry**：[Rust 構建的快速框架](https://getfoundry.sh/) - 原生 Solidity 測試
...
- **Alchemy Faucet**：[多鏈測試幣領取](https://www.alchemy.com/faucets)
- **QuickNode Faucet**：[快速獲取測試 ETH](https://faucet.quicknode.com/)
- **Chainlink Faucet**：[多種測試幣領取](https://faucets.chain.link/)

### 🔗 節點服務與 API

RPC 服務商

- **Alchemy**：[企業級區塊鏈 API](https://www.alchemy.com/) - 免費額度豐富，穩定性好
- **Infura**：[ConsenSys 區塊鏈基礎設施](https://infura.io/) - 老牌服務商
- **QuickNode**：[高效能節點服務](https://www.quicknode.com/) - 低延遲，多鏈支援

資料索引

用於快速判斷專案活躍度、TVL 與資金流向時，可配合可視化看板工具。

- **The Graph**：[去中心化索引協議](https://thegraph.com/) - GraphQL API
- **Moralis**：[Web3 後端服務](https://moralis.com/) - 一站式 Web3 開發平臺
- **Dune**：[鏈上資料查詢與視覺化](https://dune.com/)
- **DeFiLlama**：[TVL 與專案資料聚合](https://defillama.com/)
- **Token Terminal**：[協議收入與基本面資料](https://tokenterminal.com/)

### 🔐 安全工具

靜態分析

- **Slither**：[Trail of Bits 靜態分析器](https://github.com/crytic/slither) - 檢測常見漏洞
- **Mythril**：[符號執行分析](https://github.com/ConsenSysDiligence/mythril) - 深度安全掃描
- **Semgrep**：[規則驅動的程式碼掃描](https://semgrep.dev/) - 自定義檢測規則

動態測試

- **Echidna**：[屬性模糊測試](https://github.com/crytic/echidna) - Haskell 編寫的測試工具
- **Foundry Fuzz**：內建模糊測試功能
- **Manticore**：[符號執行引擎](https://github.com/trailofbits/manticore)
...
- **LXDAO**：[Web3 公共物品建設者社群](https://lxdao.io/)
- **ETHPanda**：[連線華語區與全球以太坊生態](https://ethpanda.org/)
- **HackQuest**：[Web3 駭客松平臺](https://hackquest.io/)
- **登鏈社群**：[專業區塊鏈技術社群](https://learnblockchain.cn/)
- **WTF Academy**：[Web3 開源大學](https://wtf.academy/)

國際社群

- **Ethereum Magicians**：[以太坊改進討論](https://ethereum-magicians.org/)
- **r/ethereum**：[Reddit 以太坊社群](https://www.reddit.com/r/ethereum/)
- **Ethereum Stack Exchange**：[技術問答平臺](https://ethereum.stackexchange.com/)
- **Discord 伺服器**：各大專案官方討論群

## 五、常見問題解答（FAQ）

:::: details ❓ Web3 開發需要什麼技術棧？
...
- 啟用編譯器最佳化和嚴格模式（`pragma solidity ^0.8.0`）
- 使用 **SafeMath** 或內建溢位檢查（0.8.0+）

**訪問控制**：

- 實現適當的許可權管理（Owner、Role-based）
- 避免使用 `tx.origin`，優先使用 `msg.sender`
- 考慮時間鎖（Timelock）機制保護關鍵函式
- 實現緊急暫停（Circuit Breaker）功能

**外部呼叫**：

- 優先使用 `call` 而非 `transfer/send`
- 檢查外部呼叫返回值
...
:::: details ❓ 如何跟上 Web3 最新發展？

**技術動態**：

- **GitHub 趨勢**：關注 [ethereum/EIPs](https://github.com/ethereum/EIPs)、熱門倉庫
