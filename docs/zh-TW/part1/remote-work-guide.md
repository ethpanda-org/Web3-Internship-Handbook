...
> 遠端辦公是 Web3 世界的生存法則，去中心化組織的基因決定了遠端協作的必然性。典型 Web3 團隊可能由美國的技術極客、新加坡的合規專家、東歐的智慧合約開發者組成，這種地理分佈要求成員必須具備遠端協作能力。全球頂尖的 Web3 加速器如 Seed Club，其核心團隊分佈在 12 個時區，卻透過非同步溝通工具完成每週千萬美元級專案的孵化。所以提前掌握一些基礎的 Web3 工作習慣、方式會幫助你更好的適應這個行業。
...
| **EVM**            | Ethereum Virtual Machine，以太坊虛擬機器，執行智慧合約的核心           |
| **Smart Contract** | 智慧合約，自動執行合約邏輯的鏈上程式                                 |
